module     jburk_weekday
implicit none

   interface        jed_to_weekday
   module procedure jed_to_weekday
   end interface    jed_to_weekday
   public           jed_to_weekday

   interface        weekday_to_name_common
   module procedure weekday_to_name_common
   end interface    weekday_to_name_common
   public           weekday_to_name_common

   interface        weekday_values
   module procedure weekday_values
   end interface    weekday_values
   public           weekday_values

   interface        y_common_to_astronomical
   module procedure y_common_to_astronomical
   end interface    y_common_to_astronomical
   public           y_common_to_astronomical

   interface        ymd_to_s_common
   module procedure ymd_to_s_common
   end interface    ymd_to_s_common
   public           ymd_to_s_common

   interface        ymd_to_weekday_common
   module procedure ymd_to_weekday_common
   end interface    ymd_to_weekday_common
   public           ymd_to_weekday_common

   interface        ymdf_compare
   module procedure ymdf_compare
   end interface    ymdf_compare
   public           ymdf_compare

   interface        ymdf_to_jed_common
   module procedure ymdf_to_jed_common
   end interface    ymdf_to_jed_common
   public           ymdf_to_jed_common

   interface        ymdf_to_jed_gregorian
   module procedure ymdf_to_jed_gregorian
   end interface    ymdf_to_jed_gregorian
   public           ymdf_to_jed_gregorian

   interface        ymdf_to_jed_julian
   module procedure ymdf_to_jed_julian
   end interface    ymdf_to_jed_julian
   public           ymdf_to_jed_julian
...
!> @brief  JED_TO_WEEKDAY computes the day of the week from a JED.
!> @author John Burkardt
!> @date   2002-11-07
!> @see    Edward Richards, Mapping Time, The Calendar and Its History, Oxford, 1999.
...
!
   ...
   integer(kind=4) :: i4_wrap
   integer(kind=4) :: j
   real(kind=8), intent(in) :: jed
   real(kind=8) :: jedmod
   integer(kind=4), intent(out) :: w
...
!
  ...
  return
end subroutine weekday_to_name_common
...
!
  ...
  return
end subroutine y_common_to_astronomical
...
!
  ...
  return
end subroutine ymd_to_s_common
...
!
  ...
  return
end subroutine ymd_to_weekday_common
