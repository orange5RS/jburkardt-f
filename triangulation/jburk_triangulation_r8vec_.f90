...
module jburk_triangulation_r8vec_
implicit none

   interface        r8vec_bracket
   module procedure r8vec_bracket
   end interface    r8vec_bracket
   public           r8vec_bracket

   interface        r8vec_uniform_01
   module procedure r8vec_uniform_01
   end interface    r8vec_uniform_01
   public           r8vec_uniform_01

   interface        r82vec_permute
   module procedure r82vec_permute
   end interface    r82vec_permute
   public           r82vec_permute

   interface        r82vec_sort_heap_index_a
   module procedure r82vec_sort_heap_index_a
   end interface    r82vec_sort_heap_index_a
   public           r82vec_sort_heap_index_a
...
end module jburk_triangulation_r8vec_
